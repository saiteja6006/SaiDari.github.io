...
export default class PortfolioChatbot {
    constructor(config = {}) {
        ...
        // Knowledge base containing specific open source repositories
        this.knowledgeBase = {
    ...
    appendMessage(text, isUser = false) {
        ...
        // Appended the custom tracking runtime class 'animate-chat-stream'
        ...
        // Smooth scroll adjustment calculation to prevent viewport jumping
        this.feed.scrollTo({
    ...
    handleUserMessage() {
        ...
        if (cleanToken.includes("agent") || cleanToken.includes("autogen") || cleanToken.includes("healthcare")) {
